#!/bin/bash
# larcorealg: LArSoft core geometry/algorithm libraries. Generates ROOT
# dictionaries (GeoAlgo) -> same ROOT-dictionary build pattern as larcoreobj /
# canvas_root_io (_CheckClassVersion off; see conda/potential_improvements.md #8).
set -euo pipefail
